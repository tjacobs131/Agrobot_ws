...
static const _SimCropData_type_support_symbol_names_t _SimCropData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agrobot_msgs, msg, SimCropData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, agrobot_msgs, msg, SimCropData)),
  }
};
...
{
  return &::agrobot_msgs::msg::rosidl_typesupport_cpp::SimCropData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, agrobot_msgs, msg, SimCropData)() {
  return get_message_type_support_handle<agrobot_msgs::msg::SimCropData>();
}
